            ...
            <div class="bg-white rounded-2xl p-8 text-left shadow-2xl max-w-2xl mx-auto">
                <form action="#" method="POST" onsubmit="return false;">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label class="block text-gray-700 text-sm font-medium mb-1.5">Nomor WhatsApp</label>
                            <input type="tel" name="whatsapp" placeholder="08xxxxxxxxxx"
                                   class="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                        </div>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-medium mb-1.5">Kebutuhan Anda</label>
                        <select name="need" class="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-white">
                            <option value="">Pilih jenis kebutuhan</option>
                            <option value="beli">Beli Unit Baru</option>
                            <option value="sewa">Sewa Unit</option>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="message" rows="3" placeholder="Ceritakan lokasi, jumlah unit, dan kebutuhan bisnis Anda..."
                                  class="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"></textarea>
                    </div>
                    <button type="submit"
                    ...
                    <p class="text-center text-gray-400 text-xs mt-3">Form submission aktif di Phase 3. Untuk pertanyaan segera, hubungi via WhatsApp di bawah.</p>
                </form>
            </div>
        </div>
    </section>
